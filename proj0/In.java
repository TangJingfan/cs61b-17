 ...
 *  see <tt><a
 * href="http://www.docjar.com/html/api/java/util/Scanner.java.html">
...
public final class In {
   ...
   */
  public In(Scanner scanner) { this.scanner = scanner; }
   ...
   */
  public static int[] readInts() { return new In().readAllInts(); }

  /**
   * Reads all doubles from stdin
   * @deprecated Clearer to use {@link StdIn#readAllDoubles()}
   */
  public static double[] readDoubles() { return new In().readAllDoubles(); }
