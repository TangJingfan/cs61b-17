...
public class TestPlanetConstructor {
   ...
   */
  public static void main(String[] args) { checkPlanetConstructor(); }
   ...
   */
  private static void checkEquals(double expected, double actual,
                                  String label) {
    if (expected == actual) {
   ...
   *  @param  label       Label for the 'test' case
   */
  private static void checkStringEquals(String expected, String actual,
                                        String label) {
